...
const (
	...
	WalletService_AddFunds_FullMethodName     = "/wallet.WalletService/AddFunds"
)
...
type WalletServiceClient interface {
	...
	AddFunds(ctx context.Context, in *AddFundsRequest, opts ...grpc.CallOption) (*WalletResponse, error)
}
...
func (c *walletServiceClient) AddFunds(ctx context.Context, in *AddFundsRequest, opts ...grpc.CallOption) (*WalletResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WalletResponse)
	err := c.cc.Invoke(ctx, WalletService_AddFunds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WalletServiceServer interface {
	...
	AddFunds(context.Context, *AddFundsRequest) (*WalletResponse, error)
...
func (UnimplementedWalletServiceServer) AddFunds(context.Context, *AddFundsRequest) (*WalletResponse, error) {
